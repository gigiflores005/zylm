...
E_D("replace into `zyads_loginlog` values('71','lmycgs','member','Succe','127.0.0.1','2014-03-15 19:56:46');");
E_D("replace into `zyads_loginlog` values('72','lmycgs','member','Succe','127.0.0.1','2014-03-17 23:24:11');");
E_D("replace into `zyads_loginlog` values('73','admin','admin','Succe','127.0.0.1','2014-03-17 23:25:14');");
E_D("replace into `zyads_loginlog` values('74','admin','admin','Faile','127.0.0.1','2014-03-25 00:20:13');");
E_D("replace into `zyads_loginlog` values('75','admin','admin','Succe','127.0.0.1','2014-03-25 00:20:17');");
E_D("replace into `zyads_loginlog` values('76','lmycgs','member','Succe','127.0.0.1','2014-03-25 00:21:18');");
E_D("replace into `zyads_loginlog` values('77','admin','admin','Succe','127.0.0.1','2014-04-08 20:39:46');");
E_D("replace into `zyads_loginlog` values('78','admin','admin','Succe','127.0.0.1','2014-04-09 17:08:05');");
E_D("replace into `zyads_loginlog` values('79','lmycgs','member','Succe','127.0.0.1','2014-04-12 16:49:51');");
E_D("replace into `zyads_loginlog` values('80','admin','admin','Succe','127.0.0.1','2014-04-12 16:52:00');");
