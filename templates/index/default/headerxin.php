...
<div class="header-wrap">
    ...
    <div class="header-inner-left"> <a class="logo" title="<?php echo $GLOBALS['C_ZYIIS']['sitename']?>" href="/" > <img src="/images/logo_head1.png"  alt="<?php echo $GLOBALS['C_ZYIIS']['sitename']?>"  title="<?php echo $GLOBALS['C_ZYIIS']['sitename']?>"></a>
          <div class="nav">
        <ul>
              <li>
    ...
    <div class="header-inner-right">
          <div class="login">
        <div class="unlogined">   |   <a class="menberinfo" href="affiliate" >会员登录</a><span>  |  </span> <a href="?action=register" >注册加入</a>   |   </div>
