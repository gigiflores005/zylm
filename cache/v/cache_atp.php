...
img_url = "http://www.zylm.com/images/cpmvp";
vir_width = "{width}";
vir_height = "{height}";
vir_TitleText  = "";
...
document.write("<script src=\\"http://www.zylm.com/js/xn.js\\"></script>");',
  ),
  11 => 
  array (
    'adstypeid' => '11',
    'htmltemplate' => 'yP_statsUrl= "{targeturl}"; 
yP_unionUrl="www.zylm.com"; 
yP_width={width};
yP_height={height};
yP_imgurl= "{imgurl}"; 
yP_imgServer="http://www.zylm.com"; 
yP_planType = "cpc"; 
document.write("<script src=\\"http://www.zylm.com/js/yp.js\\"></script>");',
  ),
  12 => 
  array (
    'adstypeid' => '12',
...
dL_Img_url= "{imgurl}";
dL_Img_url1= "{imgurl1}";
dL_Img_host="http://www.zylm.com";
document.write("<script src=\\"http://www.zylm.com/js/dl.js\\"></script>");
',
  ),
  13 => 
  array (
...
document.write("<script src=\\"http://www.zylm.com/js/tt.js\\"></script>");',
  ),
  15 => 
  array (
    'adstypeid' => '15',
...
yP_planType = "cpv";  
yP_tourl = "{targeturl}" 
yp_doclick2url = "http://www.zylm.com/iclk/do2click.php?type=cpv&planid={planid}&adsid={adsid}&zoneid={zoneid}";
document.write("<script src=\\"http://www.zylm.com/js/yp.js\\"></script>");
',
  ),
  16 => 
...
yP_tourl = "{adurl}";
yp_doclick2url = "http://www.zylm.com/iclk/do2click.php?type=cpv&planid={planid}&adsid={adsid}&zoneid={zoneid}";
document.write("<script src=\\"http://www.zylm.com/js/yph.js\\"></script>");',
  ),
  26 => 
  array (
    'adstypeid' => '26',
...
yP_tourl = "{targeturl}" 
yp_doclick2url = "http://www.zylm.com/iclk/do2click.php?type=cpv&planid={planid}&adsid={adsid}&zoneid={zoneid}";
document.write("<script src=\\"http://www.zylm.com/js/zp.js\\"></script>");
',
  ),
  27 => 
  array (
...
p_doclick2url = "http://www.zylm.com/iclk/do2click.php?type=cpv&planid={planid}&adsid={adsid}&zoneid={zoneid}";
